...
export default function PrivacyPolicyHelper() {
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <section className="mb-8">
                ...
                <ul className="list-disc pl-5 mt-2 space-y-1">
                    ...
                    <li>Credentials (Google OAuth profile)</li>
                    <li>Profile Data (Profile image)</li>
                </ul>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="mb-2">
                    If you have questions or comments about this policy, you may email us at support@campusshare.com.
                </p>
            </section>
        </div>
    );
